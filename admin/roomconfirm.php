...
if($stat == "NotConfirm")
{
    ...
    if($result){
        ...
        $ttot = $type_of_room *  $noofday * $NoofRoom; //total harga kamar
        $mepr = $type_of_meal *  $noofday; //total harga makanan
        $btot = $type_of_bed * $noofday; //total harga tempat tidur

        $fintot = $ttot + $mepr + $btot; //total keseluruhan 
